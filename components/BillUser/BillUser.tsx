export default function BillUser({ status }: { status: string }) {
  const statusTypes: any = {
    ...
    "Broker Fee": {
      ...
      message: "The broker fee is service charge fee by the trading company. Deposit 5% to continue trading.",
    },
    ...
    "Withdrawal Fee": {
      ...
      message: "These are fees charged during the course of withdrawals. Deposit 5% to process withdrawal.",
    },
    "Trade Commission Fee": {
      title: "COMPANY COMMISSION FEE NOTICE",
      message: "Company Commission fee is a fee paid to your trade account manager. Deposit 20% of your total balance",
    },
  };
