...
const UploadButton = ({ approveBtnClick, loading, btnText, userId, id }: ApproveBtnProps) => {
	const handleClick = () => {
	...
	return (
		<button
			onClick={handleClick}
			className="w-[110px] rounded-md  bg-gold-orange text-white py-2 px-3 flex items-center justify-center  gap-x-2"
		>
			{loading ? (
