...
const Settings = () => {
	...
	useEffect(() => {
		if (userDataState.user) {
			const { username, email, firstname, lastname, mobile, country, imgUrl } = userDataState.user;
			setUserInfo({ username, email, firstname, lastname, country, mobile });
			setImage(imgUrl);
		}
	}, [userDataState]);
							...
							<div className="p-7">
								<form onSubmit={handleUpdateUserInfo}>
									<div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
										<div className="w-full sm:w-1/2">
											...
											<div className="relative">
												...
												<input
													className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-meta3text-meta-3 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-orange-400"
													type="text"
													name="firstname"
										...
										<div className="w-full sm:w-1/2">
											...
											<div className="relative">
												...
												<input
													className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-meta3text-meta-3 focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-meta3text-meta-3"
													type="text"
													name="lastname"
													required
									...
									<div className="flex justify-end gap-4.5">
										...
										<button
											className="flex justify-center rounded bg-meta3text-meta-3 py-2 px-6 font-medium text-gray hover:bg-opacity-95"
											type="submit"
										>
											Save
										</button>
								...
								<form onSubmit={handleUpdateProfilePic}>
									<div>
										<div className="mb-4 flex items-center gap-3">
											<div className="relative h-14 w-14 bg-boxdark-2 rounded-full flex items-center justify-center">
												{image ? (
													<Image
														src={image}
														alt="user profie pic"
											...
											<div>
												...
												<span className="flex gap-2.5">
													<button className="text-sm hover:text-orange-500">Delete</button>
													<button className="text-sm hover:text-orange-500">Update</button>
												</span>
											</div>
										</div>
							...
							<div className="p-7">
								<form onSubmit={handleChangePassword}>
									...
									<div className="flex gap-4.5">
										<button
											className="flex justify-center rounded border-orange-500 border  text-orange-500 py-2 px-6 font-medium  hover:bg-opacity-95"
											type="submit"
										>
											Change Password
										</button>
