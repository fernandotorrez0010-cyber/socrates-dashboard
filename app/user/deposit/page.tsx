...
export default function Deposit() {
  ...
  const { updateDepositHistory, admin } = useUserContext();
    ...
    <div>
      ...
      <Modal modalIsOpen={modalIsOpen}>
        ...
        <p className="text-sm italic mb-8">
          To deposit, please choose the payment method at the Payment Methods panel and make the payment. After
          completing the payment come back here and fill the deposit notification form.
        </p>
